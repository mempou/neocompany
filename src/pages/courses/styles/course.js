                            ...
                            ul.social {
                                ...
                                li {
                                    a {
                                        ...
                                        &:hover {
                                            background-color: ${colors.bg3} !important;

                                            &:before {
                                                border-bottom-color: ${colors.bg3} !important;
                                            }

                                            &:after {
                                                border-top-color: ${colors.bg3} !important;
                                            }
                                        }
                                    }
                                                ...
                                                li {
                                                    a {
                                                        ...
                                                        &:hover {
                                                            ...
                                                            &:before {
                                                                border-bottom-color: ${colors.bg1} !important;
                                                            }

                                                            &:after {
                                                                border-top-color: ${colors.bg1} !important;
                                                            }
                                                        }
                                                    }
