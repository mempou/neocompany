...
function CourseFilter() {
    ...
    return (
        <Styles>
            {/* Course Area */}
            <section id='course-filter' className="course-filter">
                <Container>
                    <Row>
                        <Col md="12">
                        ...
                        <Col md="12">
                            <div className="filter-btns text-center">
                                <ul className="filter-btn-list list-unstyled list inline">
                                    <li data-target="*" className="active list-inline-item">All Services</li>
                                    <li data-target="desi" className="list-inline-item">Voyage d'études</li>
                                    <li data-target="deve" className="list-inline-item">Voyage d'affaires</li>
                                    <li data-target="seo" className="list-inline-item">Formations professionnelles</li>
                                    <li data-target="prog" className="list-inline-item">Co-working</li>
                                </ul>
                            </div>
                                    ...
                                    Datas.dataList.map((data, i) => (
                                        <Col lg="4" md="6" key={i} data-id={data.targetId}>
                                            <div className="course-item">
                                                <Link to={process.env.PUBLIC_URL + `/services/${data.courseTitle}`}>
                                                ...
                                                <div className="course-content">
                                                    <h6 className="heading"><Link to={process.env.PUBLIC_URL + `/services/${data.courseTitle}`}>{data.courseTitle}</Link></h6>
