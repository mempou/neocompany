        ...
        <Styles>
            ...
            <div className="sidebar" id="sidebar-body">
                <div className="side-logo d-flex justify-content-between">
                    <div><Link to={process.env.PUBLIC_URL + "/"}><img src={process.env.PUBLIC_URL + "/assets/images/Logo-Default.svg"} alt="" /></Link></div>
                    <div><a href={process.env.PUBLIC_URL + "/"} id="close-sidebar"><i className="las la-times"></i></a></div>
                </div>
                <div className="side-content">
                    <h5>À propos de nous</h5>
                    <p>Nous sommes une agence professionnelle qui, vous ouvre les portes aux grandes écoles étrangères, vous aide à voyager à l'étranger (études ou affaires), vous propose des formations professionnelles de pointes et qui, vous loue des salles équipées..</p>
                </div>
                ...
                <div className="side-contact">
                    ...
                    <ul className="list-unstyled">
                        <li><i className="las la-map-marker"></i>Douala, Cameroun</li>
                        <li><i className="las la-phone"></i>+237 679 298 548</li>
                        <li><i className="las la-envelope"></i>contact@neocompany.com</li>
                    </ul>
                </div>
                <div className="side-social">
                    <ul className="list-unstyled list-inline">
                        <li className="list-inline-item"><a href={ "https://web.facebook.com/agenceneocompany/?_rdc=1&_rdr"}><i className="fab fa-facebook-f"></i></a></li>
