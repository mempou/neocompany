...
function HelpArea() {
    ...
    return (
        <Styles>
            {/* Help Area */}
            <section className="home-contact-area" style={{ backgroundImage: `url(${process.env.PUBLIC_URL}/assets/images/${Datas})` }}>
                <Container>
                    <Row>
                        <Col md="12">
                        ...
                        <Col md="12">
                            <form id="form1" className="form">
                                <Row>
                                    ...
                                    <Link to={process.env.PUBLIC_URL + "/contact"}><button>Contactez-nous</button></Link>
